...
public class ToyActivity extends BaseActivity<IView, Presenter<IView>> implements IView {
    ...
    protected void initEventAndData() {
        ...
        mPresenter.getDataP1("", DifferentiateEnum.MALLADFIVE,loadingLayout);
        mPresenter.getDataP1("", DifferentiateEnum.MALLADEIGHT,loadingLayout);
        ...
        mRlvAdapterOwn.setOnClickLisiter(new RlvAdapter_own.onClickLisiter() {
            ...
            public void onClicker(View view, int position, List<MallAdBean.ResultBean> mData) {
                ...
                if ("STUDY_COURSE".equals(route)) {
                    Intent intent = new Intent(ToyActivity.this, ClassListActivity.class);
                    intent.putExtra("target", target);
                    startActivity(intent);
                } else if ("MALL_SKU".equals(route)) {
                    Intent intent = new Intent(ToyActivity.this, ShopActivity.class);
                    intent.putExtra("target", target);
                    startActivity(intent);
                } else if ("WEB".equals(route)) {
                    Intent intent = new Intent(ToyActivity.this, WebActivity.class);
                    intent.putExtra("target", target);
    ...
    private void initTab() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                simplePagerTitleView.setNormalColor(ContextCompat.getColor(ToyActivity.this, R.color.colorTextSubhead));
                simplePagerTitleView.setSelectedColor(ContextCompat.getColor(ToyActivity.this, R.color.colorTextTitleHome));
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                indicator.setColors(ContextCompat.getColor(ToyActivity.this, R.color.colorToy));
                return indicator;
            }
        });
            ...
            case MALLADEIGHT:
                ...
                mBanner.setOnBannerListener(new OnBannerListener() {
                    ...
                    public void OnBannerClick(int position) {
                        ...
                        String title = result1.get(position).getTitle();
                        if ("STUDY_COURSE".equals(route)) {
                            Intent intent = new Intent(ToyActivity.this, ClassListActivity.class);
                            intent.putExtra("target", target);
                            startActivity(intent);
