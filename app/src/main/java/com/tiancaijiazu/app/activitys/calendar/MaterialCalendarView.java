...
import com.tiancaijiazu.app.activitys.calendar.format.ArrayWeekDayFormatter;
import com.tiancaijiazu.app.activitys.calendar.format.DayFormatter;
import com.tiancaijiazu.app.activitys.calendar.format.MonthArrayTitleFormatter;
import com.tiancaijiazu.app.activitys.calendar.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  public void setSelectionColor(int color) {
    ...
    accentColor = Color.parseColor("#00DEFF");
    adapter.setSelectionColor(Color.parseColor("#00DEFF"));
    invalidate();
  }
  ...
  /**
   * Set a {@linkplain com.tiancaijiazu.app.activitys.calendar.format.WeekDayFormatter}
   * with the provided week day labels
   *
   * @param weekDayLabels Labels to use for the days of the week
   * @see com.tiancaijiazu.app.activitys.calendar.format.ArrayWeekDayFormatter
   * @see #setWeekDayFormatter (com.example.administrator.demorilithree.format.WeekDayFormatter)
   */
  ...
  /**
   * Set a {@linkplain com.tiancaijiazu.app.activitys.calendar.format.TitleFormatter}
   * using the provided month labels
   *
   * @param monthLabels month labels to use
   * @see com.tiancaijiazu.app.activitys.calendar.format.MonthArrayTitleFormatter
