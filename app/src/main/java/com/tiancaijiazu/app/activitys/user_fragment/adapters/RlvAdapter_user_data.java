...
public class RlvAdapter_user_data extends RecyclerView.Adapter {
    public List<MyReleasedListBean.ResultBean> mData;
    private Context mContext;
    private onClickLisiter mLisiter;
    private onClickLisiterXin mLisiterXin;

    public RlvAdapter_user_data(List<MyReleasedListBean.ResultBean> articleList, Context context) {
    ...
    public void addData(List<MyReleasedListBean.ResultBean> articleList, boolean b) {
        if(b){
            if(mData!=null){
                mData.clear();
            }
    ...
    public interface onClickLisiter{
        void onClicker(View view,int position,List<MyReleasedListBean.ResultBean> mData);
    }
    ...
    public interface onClickLisiterXin{
        void onClickerXin(View view,int position,List<MyReleasedListBean.ResultBean> mData);
    }
