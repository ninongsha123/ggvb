...
public class RlvAdapter_comment_two extends RecyclerView.Adapter {
    private int mReplyCount;
    private boolean mIsboo;
    private long mDiscussId;
    private long mUserId;
    public List<ArticleDatas.ResultBean.DiscussListBean.SubDiscussBean> mData;
    ...
    public RlvAdapter_comment_two(List<ArticleDatas.ResultBean.DiscussListBean.SubDiscussBean> discussListBeans, RecDataActivity context, long userId, long discussId, boolean isboo, int replyCount) {
        this.mData = discussListBeans;
        this.mContext = context;
        this.mUserId = userId;
        this.mDiscussId = discussId;
        if(page == 1){
            this.mIsboo = isboo;
        }
    ...
    public int getItemCount() {
        if(mIsboo&&mData.size()!=mReplyCount){
            return mData.size() + 1;
        }else {
            return mData.size();
        }
    ...
    public void addTwoData(List<TwoCommentBean.ResultBean> result1) {
        ...
        for (int i = 0; i < result1.size(); i++) {
            mData.add(new ArticleDatas.ResultBean.DiscussListBean.SubDiscussBean(result1.get(i).getDiscussId(),
    ...
    public interface onClickLisiterTwoHui {
        void onClickTwoHui(View view, int position, List<ArticleDatas.ResultBean.DiscussListBean.SubDiscussBean> mData);
    }
    ...
    public interface onClickLisiter {
        void onClicker(View view, int position, List<ArticleDatas.ResultBean.DiscussListBean.SubDiscussBean> mData);
    }
    ...
    public interface onClickLisiterUser{
        void onClickerUser(View view,int position,List<ArticleDatas.ResultBean.DiscussListBean.SubDiscussBean> mData);
    }
