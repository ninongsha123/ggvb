...
public class RlvAdapter_two_video_title extends RecyclerView.Adapter {
    private ArrayList<ContentsBean> mData;
    private VideoActivity mContext;
    private onClickLisiter mLisiter;

    public RlvAdapter_two_video_title(ArrayList<ContentsBean> contentsList, VideoActivity context) {
