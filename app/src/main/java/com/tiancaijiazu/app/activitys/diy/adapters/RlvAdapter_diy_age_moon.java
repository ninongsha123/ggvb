...
public class RlvAdapter_diy_age_moon extends RecyclerView.Adapter {
    private ArrayList<Integer> mData;
    private int position = 0;
    private onClickLisiter mLisiter;

    public RlvAdapter_diy_age_moon(ArrayList<Integer> drawables) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_diy_age_moon, viewGroup, false);
