...
public class RlvAdapter_video_two_list extends RecyclerView.Adapter {
    private ArrayList<VideoTwoExtractBean> mData;
    private VideoActivity mContext;
    private onClickLisiter mLisiter;

    public RlvAdapter_video_two_list(ArrayList<VideoTwoExtractBean> result, VideoActivity videoActivity) {
            this.mData = result;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        RlvAdapter_two_video_title rlvAdapterTwoVideoTitle = new RlvAdapter_two_video_title(contentsList,mContext);
        holder.mRecyler.setAdapter(rlvAdapterTwoVideoTitle);
        rlvAdapterTwoVideoTitle.setOnClickLisiter(new RlvAdapter_two_video_title.onClickLisiter() {
            @Override
