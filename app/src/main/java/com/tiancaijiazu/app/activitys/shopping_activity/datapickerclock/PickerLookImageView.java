 ...
 * 修改时间：2018/12/21
 */
public class PickerLookImageView extends View {
    ...
    private static class ScrollHandler extends Handler {
        private WeakReference<PickerLookImageView> mWeakView;

        private ScrollHandler(PickerLookImageView view) {
            mWeakView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            PickerLookImageView view = mWeakView.get();
            if (view == null) return;
    ...
    public PickerLookImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.colorlookImage);
        mDarkColor = ContextCompat.getColor(mContext, R.color.colorTextTitleHome);
    }
