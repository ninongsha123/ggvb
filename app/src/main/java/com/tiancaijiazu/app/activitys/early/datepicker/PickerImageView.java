package com.tiancaijiazu.app.activitys.early.datepicker;
...
public class PickerImageView extends View {
    ...
    private static class ScrollHandler extends Handler {
        private WeakReference<PickerImageView> mWeakView;

        private ScrollHandler(PickerImageView view) {
            mWeakView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            PickerImageView view = mWeakView.get();
            if (view == null) return;
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.colorZhu);
