...
public class FlowGroupView_history extends ViewGroup {
    ...
    private setLineSum mLisiter;

    public FlowGroupView_history(Context context, AttributeSet attrs,
                                 int defStyleAttr) {
    ...
    public FlowGroupView_history(Context context) {
        super(context);
    }
...
//              lineHeight = cheight; // 记录下一行的高度
    ...
    public interface setLineSum{
        void lineSum(int sum);
    }

    public void onGetSum(setLineSum lineSum){
        this.mLisiter = lineSum;
    }
}
