...
public class RlvAdapter_my_collect extends RecyclerView.Adapter {
    public ArrayList<MyCollectListBean.ResultBean> mData;
    private Context mContext;
    private onClickLisiterPraise mLisiter;
    private onClickLisiter mLisiterJ;
    private onClickLisiterUser mLisiterUser;

    public RlvAdapter_my_collect(ArrayList<MyCollectListBean.ResultBean> resultBeans, Context myCollectActivity) {
    ...
    public void addData(List<MyCollectListBean.ResultBean> result, boolean b) {
        if(b){
            if(mData!=null){
                mData.clear();
            }
    ...
    public interface onClickLisiterPraise {
        void onClickPraise(View view, int position, CheckBox mIvCollect, ArrayList<MyCollectListBean.ResultBean> mData);
    }
    ...
    public interface onClickLisiter{
        void onClickLisiter(View view,int position,ArrayList<MyCollectListBean.ResultBean> mData);
    }
