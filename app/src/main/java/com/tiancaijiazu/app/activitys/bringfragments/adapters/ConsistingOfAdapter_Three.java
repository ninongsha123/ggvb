...
public class ConsistingOfAdapter_Three extends RecyclerView.Adapter {
    private ArrayList<ConsistingOfBean> mData;
    private onClickLisiter mLisiter;

    public ConsistingOfAdapter_Three(ArrayList<ConsistingOfBean> rlv_one) {
        this.mData = rlv_one;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.consisting_of_three, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        holder.mTitleThree.setText(mData.get(i).getTitle());
