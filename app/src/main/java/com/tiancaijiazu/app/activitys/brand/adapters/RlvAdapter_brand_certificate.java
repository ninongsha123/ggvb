...
public class RlvAdapter_brand_certificate extends RecyclerView.Adapter {
    private String[] mData;
    private BrandIntroductionActivity mContext;
    private onClickLisiter mLisiter;

    public RlvAdapter_brand_certificate(String[] split1, BrandIntroductionActivity brandIntroductionActivity) {
        this.mData = split1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_brand_certificate, viewGroup, false);
