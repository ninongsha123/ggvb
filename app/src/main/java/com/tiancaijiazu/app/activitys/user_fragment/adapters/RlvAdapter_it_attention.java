...
public class RlvAdapter_it_attention extends RecyclerView.Adapter {
    private boolean mIsbo;
    private List<ItAttentionBean.ResultBean> mData;
    private AttentionOfItActivity mContext;
    private onClickLisiter mLisiter;
    private onClickLisiterUser mLisiterUser;

    public RlvAdapter_it_attention(List<ItAttentionBean.ResultBean> result, AttentionOfItActivity attentionOfItActivity, boolean isbo) {
        this.mData = result;
        this.mContext = attentionOfItActivity;
        this.mIsbo = isbo;
    }
    ...
    public void addData(List<ItAttentionBean.ResultBean> result, boolean b) {
        if(b){
            if(mData!=null){
                mData.clear();
            }
    ...
    public interface onClickLisiter{
        void onClicker(View view,int position,List<ItAttentionBean.ResultBean> mData);
    }
    ...
    public interface onClickLisiterUser{
        void onClickerUser(View view,int position,List<ItAttentionBean.ResultBean> mData);
    }
