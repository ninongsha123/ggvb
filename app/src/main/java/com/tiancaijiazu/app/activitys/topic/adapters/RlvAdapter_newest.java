...
public class RlvAdapter_newest extends RecyclerView.Adapter {
    public List<TopicDataBean.ResultBean.ArticleListBean> mData;
    private Context mContext;
    private onClickLisiter mLisiter;
    private onClickLisiterData mLisiterData;

    public RlvAdapter_newest(List<TopicDataBean.ResultBean.ArticleListBean> articleList, Context context) {
