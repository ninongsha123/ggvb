...
public class PopularizeClassActivity extends BaseActivity<IView, Presenter<IView>> implements IView {
    ...
    protected void initEventAndData() {
        ...
        mPresenter.getDataP(1, DifferentiateEnum.QRCODE);
    }

    @Override
    protected int creatrLayoutId() {
        return R.layout.activity_popularize_class;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.invite_down:
                DonwloadSaveImg.donwloadImg(PopularizeClassActivity.this, imageUrl);//iPath
                break;
        }
    }
