...
import com.tiancaijiazu.app.activitys.video.bean.ParentBean;
...
public class ExpandableListViewAdapter_video extends BaseExpandableListAdapter{
    // 定义一个Context
    private Context context;
    // 定义一个LayoutInflater
    private LayoutInflater mInflater;
    // 定义一个List来保存列表数据
    private ArrayList<ParentBean> data_list = new ArrayList<>();
    private HolderView childrenView;

    // 定义一个构造方法
    public ExpandableListViewAdapter_video(Context context, ArrayList<ParentBean> datas) {
    ...
    // 刷新数据
    public void flashData(ArrayList<ParentBean> datas) {
        this.data_list = datas;
    ...
    public Object getChild(int arg0, int arg1) {
        return data_list.get(arg0).getResult().get(arg1);
    }
    ...
    public View getChildView(int arg0, int arg1, boolean arg2, View arg3, ViewGroup arg4) {
         ...
         */
        // 设置标题上的文本信息
        //childrenView.title.setText(data_list.get(arg0).getResult().get(arg1).getTitle());
        // 设置副标题上的文本信息
        //判断课程是否免费
    ...
    public int getChildrenCount(int arg0) {
        return data_list.get(arg0).getResult().size();
    }
