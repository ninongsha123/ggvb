...
public class RlvAdapter_userGroup extends RecyclerView.Adapter {
    public List<DiaryDetailBean.ResultBean> mData;
    private Context mContext;
    private onClickLisiter mLisiter;
    private onClickLisiterXin mLisiterXin;

    public RlvAdapter_userGroup(List<DiaryDetailBean.ResultBean> collectList, Context context) {
    ...
    public void addData(List<DiaryDetailBean.ResultBean> collectList, boolean b) {
        if(b){
            if(mData!=null){
                mData.clear();
            }
    ...
    public interface onClickLisiter{
        void onClicker(View view, int positon, List<DiaryDetailBean.ResultBean> mData);
    }
    ...
    public interface onClickLisiterXin{
        void onClickerXin(View view, int position, List<DiaryDetailBean.ResultBean> mData);
    }
