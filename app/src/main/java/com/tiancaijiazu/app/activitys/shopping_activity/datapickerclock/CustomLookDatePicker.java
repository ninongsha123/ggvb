package com.tiancaijiazu.app.activitys.shopping_activity.datapickerclock;
 ...
 * 修改时间：2018/12/21
 */
public class CustomLookDatePicker implements View.OnClickListener, PickerLookImageView.OnSelectListener {
    ...
    private PickerLookImageView mDpvHour, mDpvMinute;
     ...
     */
    public CustomLookDatePicker(Context context, Callback callback, String beginDateStr, String endDateStr) {
        this(context, callback, LookDateFormatUtils.str2Long(beginDateStr, true),
                LookDateFormatUtils.str2Long(endDateStr, true));
    }
     ...
     */
    public CustomLookDatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mPickerDialog.setContentView(R.layout.dialog_date_picker_clock);
        ...
        mPickerDialog.findViewById(R.id.ok).setOnClickListener(this);
    ...
    public boolean setSelectedTime(String dateStr, boolean showAnim) {
        return canShow() && !TextUtils.isEmpty(dateStr)
                && setSelectedTime(LookDateFormatUtils.str2Long(dateStr, mCanShowPreciseTime), showAnim);
    }
