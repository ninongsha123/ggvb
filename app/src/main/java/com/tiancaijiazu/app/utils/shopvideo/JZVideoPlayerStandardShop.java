...
public class JZVideoPlayerStandardShop extends JZVideoPlayerShop {
    ...
    public JZVideoPlayerStandardShop(Context context) {
        super(context);
    }

    public JZVideoPlayerStandardShop(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            EventBus.getDefault().post(new DownFinis(true));
            backPress();
        } else if (i == R.id.back_tiny) {
            if (JZVideoPlayerManagerShop.getFirstFloor().currentScreen == JZVideoPlayerShop.SCREEN_WINDOW_LIST) {
