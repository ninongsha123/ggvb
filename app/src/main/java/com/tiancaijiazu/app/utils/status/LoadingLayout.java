...
//    private TextView networkReloadBtn;
    ...
    private void build() {
        ...
        mRef = Utils.findViewById(networkPage, R.id.ref);
      ...
      //  networkReloadBtn = Utils.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        networkImg.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mRef.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
...
/**
    ...
    public static class Config {
        ...
        String emptyStr = "暂时还没有数据呢";
        String errorStr = "出错啦~请稍后重试！";
        String netwrokStr = "没网络了，刷新一下试试吧";
        String reloadBtnStr = "点击重试";
        int emptyImgId = R.mipmap.undata;
        int errorImgId = R.mipmap.undata;
        int networkImgId = R.mipmap.wu_network;
        int reloadBtnId = R.drawable.biankuang;
        int tipTextSize = 14;
        int buttonTextSize = 14;
        int tipTextColor = R.color.colorsix;
        int buttonTextColor = R.color.color_releay;
        int buttonWidth = -1;
        int buttonHeight = -1;
        int loadingLayoutId = R.layout.widget_loading_page;
        View loadingView = null;
        int backgroundColor = R.color.colorbackgroud;
