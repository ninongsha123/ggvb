...
public class JZVideoPlayerStandardAudition extends JZVideoPlayerAudition {
    ...
    public JZVideoPlayerStandardAudition(Context context) {
        super(context);
    }

    public JZVideoPlayerStandardAudition(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setUp(Object[] dataSourceObjects, int defaultUrlMapIndex, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            changeStartButtonSize((int) getResources().getDimension(R.dimen.dp_50));
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (JZVideoPlayerManagerAudition.getFirstFloor().currentScreen == JZVideoPlayerAudition.SCREEN_WINDOW_LIST) {
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            ...
            startButton.setImageResource(R.mipmap.max_pause_audition);
            ...
            startButton.setVisibility(VISIBLE);
            startButton.setImageResource(R.mipmap.max_play_audition);
