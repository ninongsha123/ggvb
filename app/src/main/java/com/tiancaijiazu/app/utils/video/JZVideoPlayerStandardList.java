...
public class JZVideoPlayerStandardList extends JZVideoPlayerList {
    ...
    public JZVideoPlayerStandardList(Context context) {
        super(context);
    }

    public JZVideoPlayerStandardList(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void init(Context context) {
        ...
        mFenXiang = findViewById(R.id.share);
        ...
        mVideoSpeed = findViewById(R.id.video_speed);
    ...
    public void setUp(Object[] dataSourceObjects, int defaultUrlMapIndex, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            //mFenXiang.setVisibility(VISIBLE);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (JZVideoPlayerManagerList.getFirstFloor().currentScreen == JZVideoPlayerList.SCREEN_WINDOW_LIST) {
    ...
    public void setBatteryLevel() {
        ...
        if (percent < 15) {
            //.setBackgroundResource(R.drawable.jz_battery_level_10);
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        Log.i(TAG, "one"+topCon+"-----: two"+bottomCon+"-----three"+startBtn+"----four"+loadingPro+"-----five"+thumbImg+"----six"+bottomPro+"---seven"+retryLayout);
        if(mLock.isChecked()){
            Log.i(TAG, topCon+"1-----: 2"+bottomCon+"-----3"+startBtn+"----4"+loadingPro+"-----5"+thumbImg+"----6"+bottomPro+"---7"+retryLayout);
            ...
            mVideoSpeed.setVisibility(INVISIBLE);
        }else {
            if(mRecylerView.getVisibility() == VISIBLE){
                ...
                mVideoSpeed.setVisibility(VISIBLE);
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            //startButton.setVisibility(VISIBLE);
            startButton.setImageResource(R.mipmap.videolist_pause);
            replayTextView.setVisibility(INVISIBLE);
            int visibility = startButton.getVisibility();
            Log.i(TAG, "updateStartImage: "+visibility);
            EventBus.getDefault().post(new ControlEvent(true));
        } else if (currentState == CURRENT_STATE_ERROR) {
            startButton.setVisibility(INVISIBLE);
            replayTextView.setVisibility(INVISIBLE);
        } else if (currentState == CURRENT_STATE_AUTO_COMPLETE) {
            startButton.setVisibility(VISIBLE);
            startButton.setImageResource(R.mipmap.videolist_play);
            replayTextView.setVisibility(VISIBLE);
            int visibility = startButton.getVisibility();
            Log.i(TAG, "updateStartImage: "+visibility);
            EventBus.getDefault().post(new ControlEvent(false));
        } else {
            startButton.setImageResource(R.mipmap.videolist_play);
            replayTextView.setVisibility(INVISIBLE);
            EventBus.getDefault().post(new ControlEvent(false));
        ...
        if (currentState != CURRENT_STATE_NORMAL
            ...
            post(new Runnable() {
                ...
                public void run() {
                    ...
                    //mFenXiang.setVisibility(View.INVISIBLE);
