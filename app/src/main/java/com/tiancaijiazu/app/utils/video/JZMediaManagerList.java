...
public class JZMediaManagerList implements TextureView.SurfaceTextureListener {
    ...
    public static JZMediaManagerList jzMediaManager;
    public int positionInList = -1;
    public JZMediaInterfaceList jzMediaInterface;
    ...
    public JZMediaManagerList() {
        mMediaHandlerThread = new HandlerThread(TAG);
        mMediaHandlerThread.start();
        mMediaHandler = new MediaHandler(mMediaHandlerThread.getLooper());
        mainThreadHandler = new Handler();
        if (jzMediaInterface == null)
            jzMediaInterface = new JZMediaSystemList();
    }

    public static JZMediaManagerList instance() {
        if (jzMediaManager == null) {
            jzMediaManager = new JZMediaManagerList();
        }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i1) {
        Log.i(TAG, "onSurfaceTextureAvailable [" + JZVideoPlayerManagerList.getCurrentJzvd().hashCode() + "] ");
