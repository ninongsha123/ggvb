...
public class GlueTabLayout extends HorizontalScrollView {
    ...
    public GlueTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.tabTextAppearance = a.getResourceId(styleable.TabLayout_tabTextAppearance, R.style.MyTabText);
        ...
        try {
            ...
            Log.i("yx", "GlueTabLayout: " + tabTextSize);
    ...
    class TabView extends LinearLayout {
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (this.textView != null) {
                ...
                if (textSize != curTextSize || curMaxLines >= 0 && maxLines != curMaxLines) {
                    ...
                    if (updateTextView) {
                        Log.i("yx", "onMeasure:===== ");
                        this.textView.setTextSize(0, 30);
        ...
        final void update() {
            ...
            if (this.customView == null) {
                if (this.iconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(this.getContext()).inflate(R.layout.item, this, false);
                ...
                if (this.textView == null) {
                    TextView textView = (TextView) LayoutInflater.from(this.getContext()).inflate(R.layout.item2, this, false);
